  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php else: ?>
          <a class="nav-link" href="calculamulti.php">Multiplicação</a>
        <?php endif; ?>
        ...
        <?php else: ?>
          <a class="nav-link" href="calcdiv.php">Divisão</a>
        <?php endif; ?>
        ...
        <?php else: ?>
          <a class="nav-link" href="calculasubtração.php">Subtração</a>
        <?php endif; ?>
